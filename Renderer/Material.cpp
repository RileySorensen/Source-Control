...
bool Lambertian::Scatter(const Ray& ray, const RayHit& hit, color3& attenuation, Ray& scattered) const
{
...
bool Metal::Scatter(const Ray& ray, const RayHit& hit, color3& attenuation, Ray& scattered) const
{
...
bool Dilectric::Scatter(const Ray& ray, const RayHit& hit, color3& attenuation, Ray& scattered) const
{
